...
function actionLogin() {
    ...
    if (document.loginForm.id.value =="") {
        ...
        document.loginForm.action="<c:url value='/softdb/actionLogin.do'/>";
...
<div id="wrap">
    ...
    <div id="topnavi">
    	...
    	<ul>
			<li><a href="#">PCRM Login Page</a></li>
		</ul>
    </div>
    <!-- //header 끝 -->
    <!-- container 시작 -->
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <!-- 타이틀 이미지 -->            
                <%-- <div id="content_img_div"><img  alt="PCRM LOGIN" src="<c:url value='/'/>images/subtitle/img_subtitle_login.gif" width="776" height="230" /></div> --%>       
                <div id="content_img_div"><img  alt="PCRM LOGIN" src="<c:url value='/'/>softdb/img/loginbg.png" width="810" /></div>       
                            ...
                            <div class="user_login_ultop">
                                <ul>
                                    <li>
                                        ...
                                        <input type="text" class="input_style" title="아이디를 입력하세요." id="id" name="usrId" maxlength="10"/>
                                    </li>
                                    <li>
