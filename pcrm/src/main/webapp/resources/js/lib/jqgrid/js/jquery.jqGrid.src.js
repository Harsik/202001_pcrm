...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		$("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'><img src='/resources/images/loading.gif'alt='loading' width='30' height='30'></div>").insertBefore(gv);
