...
//	DEXT5.configInitServerXml = "http://counsel.pyeongtaek.go.kr:8080/resources/js/lib/dext5editor/handler/upload_handler.ashx?f=dext_editor.xml";
...
//	new Dext5editor(editNm);
	editNm = new KuKudocsEditor(
            ...
            /* Option 입력부 */
            {
                ...
                //Hidden Menu 설정
                hiddenMenu: ['fileGroup', 'editGroup', 'headingGroup', 'fontFamilyGroup', 'fontSizeGroup', 'textFormatGroup', 'paragraphFormatGroup','insertGroup', 'tableGroup', 'toolGroup', 'viewGroup', 'helpGroup'], /* Menu Option Hidden list */
                ...
                licenseKey : ["input license key"], //라이센스 입력
		...
		if(cntrcd==""||cntrcd=="all") {	
			...
			{ 
				if (usrId != "sysmanager" && usrId != "generalmanager" && usrId != "manager001") {
					...
					if (state.team_cd == "1001" || state.team_cd == "9000") {
						value += "<option value='" + state.usr_id + "'>" + state.usr_nm + "</option>";
					};
				};
			});
...
function getImgUrl()
{
   return "http://counsel.pyeongtaek.go.kr:8080/";
