...
<html lang="ko">
	<head>
		...
		<script type="text/javascript" src="<c:url value='/resources/js/common/counselList.js'/>"></script>		
				...
				<table summary="상담이력조회" class="search2_tbl">
					...
					<tr>
						...
						<td colspan="3">
							...
							<select class="select_al" style="width:190px;" id="cslist_selSrchIntvSmCd" title="소분류"></select>
						</td>
						<th scope="row">인식결과</th>
						<td style="width:90px;">
							<select class="select_al" id="cslist_stt_rcg_rst" title="인식결과"></select>
						</td>
						<th scope="row">주소</th>
						<td style="width:90px;">
							<select class="select_al" id="cslist_hAddr" title="주소"></select>
						</td>
